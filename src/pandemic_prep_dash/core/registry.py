...
from ..models.agent import AgentTeamConfig, HarnessEngineType, AgentRole, ModelProviderConfig, ModelProviderType
    ...
    nodes = [
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Ingestion Squad",
                description="Sample & sequence intake team",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Threat Research Squad",
                description="PubMed & threat intelligence squad",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="bioinformatics_squad",
                name="Genomics Squad",
                description="Phylogenetic identification & mutation scanning squad",
                lead_role=AgentRole.BIOINFORMATICS_LEAD,
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Structural Biology Squad",
                description="AlphaFold 3D target prediction squad",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Biosecurity & SSBA Squad",
                description="SSBA classification & dual-use audit squad",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Medicinal Chemistry Squad",
                description="Virtual screening & ARTG docking squad",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Vaccinology Squad",
                description="Epitope prediction & sovereign mRNA squad",
                lead_role=AgentRole.VACCINE_IMMUNOLOGIST,
                harness_engine=HarnessEngineType.OPENCODE,
                harness_command="opencode run",
                sandbox_policy="restricted_fs",
            ),
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                ...
                name="Policy Liaison Squad",
                description="Commonwealth inter-agency reporting squad",
...
def create_default_chemical_pathway() -> Pathway:
    ...
    nodes = [
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="bioinformatics_squad",
                name="Cheminformatics Squad",
                description="Chemical specimen ingestion squad",
                lead_role=AgentRole.MEDICINAL_CHEMIST,
                harness_engine=HarnessEngineType.AGY,
                harness_command="agy exec",
                sandbox_policy="restricted_fs",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="research_squad",
                name="Toxicology Intelligence Squad",
                description="PubMed toxicology surveillance squad",
                lead_role=AgentRole.SCIENTIFIC_RESEARCHER,
                harness_engine=HarnessEngineType.CLAUDE_CODE,
                harness_command="claude -p",
                sandbox_policy="restricted_fs",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="biosecurity_squad",
                name="CWC Verification Squad",
                description="Chemical forensics & schedule verification squad",
                lead_role=AgentRole.BIOSECURITY_ANALYST,
                harness_engine=HarnessEngineType.CODEX,
                harness_command="codex exec",
                sandbox_policy="restricted_fs",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="medicinal_chemistry_squad",
                name="Pharmacology & Antidotes Squad",
                description="AChE reactivation & oxime screening squad",
                lead_role=AgentRole.MEDICINAL_CHEMIST,
                harness_engine=HarnessEngineType.AGY,
                harness_command="agy exec",
                sandbox_policy="restricted_fs",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="biosecurity_squad",
                name="CBRN Plume & Exclusion Squad",
                description="Chemical vapor plume & cordon squad",
                lead_role=AgentRole.BIOSECURITY_ANALYST,
                harness_engine=HarnessEngineType.SOVEREIGN_CONTAINER,
                harness_command="podman run --network none -v /sandbox:/workspace:Z",
                sandbox_policy="isolated_container",
        ...
        PathwayNode(
            ...
            agent_team_config=AgentTeamConfig(
                team_id="policy_squad",
                name="National Security SITREP Squad",
                description="Home Affairs & Defence liaison squad",
                lead_role=AgentRole.WHOLE_OF_GOV_LIAISON,
                harness_engine=HarnessEngineType.CLAUDE_CODE,
                harness_command="claude -p",
                sandbox_policy="restricted_fs",
